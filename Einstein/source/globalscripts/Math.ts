...
Math.exp = function (x) {
    if (x < 0)
        var iPart = 1 / intPow(Math.E, -Math.floor(x));
    else
        var iPart = intPow(Math.E, Math.floor(x));
...
function euclidDistance2DSquared(x1, y1, x2, y2) {
 ...
 */
function euclidDistance2D(x1, y1, x2, y2) {
    return Math.sqrt(euclidDistance2DSquared(x1, y1, x2, y2));
}

function euclidDistance3DSquared(x1, y1, z1, x2, y2, z2) {
    return square(x2 - x1) + square(y2 - y1) + square(z2 - z1);
}

function euclidDistance3D(x1, y1, z1, x2, y2, z2) {
    return Math.sqrt(euclidDistance3DSquared(x1, y1, z1, x2, y2, z2));
}