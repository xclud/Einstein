 ...
 */
function heapsPermute<T>(array: T[], cloneFunc: (value: T, index?: number, array?: T[]) => any, callback: (values: any[]) => void) {
 ...
 */
function listFiles(path: string, extension: string, recurse: boolean): string[] {
