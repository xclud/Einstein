class ChainPlacer implements ICenteredPlacer, IPlacer {
    minRadius: number;
    maxRadius: number;
    numCircles: number;
    failFraction: number;
     ...
     */
    constructor(minRadius: number, maxRadius: number, numCircles: number, failFraction: number = 0, centerPosition: Vector2D = undefined, maxDistance: number = 0, queue: number[] = []) {
