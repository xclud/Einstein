 ...
 */
class ClumpPlacer implements ICenteredPlacer, IPlacer {
     ...
     */
    constructor(size: number, coherence: number, smoothness: number, failFraction: number = 0, centerPosition: Vector2D = undefined) {
        this.size = size;
