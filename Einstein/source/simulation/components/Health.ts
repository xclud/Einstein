class Health extends Component {
    ...
    hitpoints: number;
    regenRate: number;
    idleRegenRate: number;
    regenTimer: number | undefined;
    damageVariant: string | undefined;
