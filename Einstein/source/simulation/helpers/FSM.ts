...
class FSM {
    ...
    SetNextState(obj, state) {
        obj.fsmNextState = state;
        obj.fsmReenter = false;
    };


    SetNextStateAlwaysEntering(obj, state) {
        obj.fsmNextState = state;
    ...
    LookupState(currentStateName, stateName) {
    ...
    SwitchToNextState(obj, nextStateName) {
