...
function ChangeEntityTemplate(oldEnt: number, newTemplate) {
    ...
    var cmpHealth = Engine.QueryInterface<Health>(oldEnt, IID_Health);
    var cmpNewHealth = Engine.QueryInterface<Health>(newEnt, IID_Health);
